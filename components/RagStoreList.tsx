            ...
            <div className="flex justify-between items-center mb-4">
                ...
                <div className="flex items-center space-x-2">
                    ...
                    <button
                        ...
                        className="p-2 bg-gem-red hover:bg-red-600 rounded-full text-white transition-colors disabled:bg-gem-mist"
                        disabled={isLoading}
                    ...
                    <div className="bg-gem-slate p-6 rounded-lg shadow-xl w-full max-w-md">
                        ...
                        <form onSubmit={handleConfirmCreate}>
                            ...
                            <input
                                ...
                                className="w-full bg-gem-mist border border-gem-mist/50 rounded-md py-2 px-4 focus:outline-none focus:ring-2 focus:ring-gem-red mb-4"
                                autoFocus
                            />
                            <div className="flex justify-end space-x-2">
                                ...
                                <button
                                    ...
                                    className="px-4 py-2 rounded-md bg-gem-red hover:bg-red-600 text-white transition-colors disabled:bg-gem-mist/50 disabled:cursor-not-allowed"
