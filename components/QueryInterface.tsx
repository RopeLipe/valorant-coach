        ...
        <div className="flex flex-col h-full">
            ...
            <form onSubmit={handleSubmit} className="flex items-center space-x-2">
                <input
                    ...
                    className="flex-grow bg-gem-mist border border-gem-mist/50 rounded-full py-2 px-4 focus:outline-none focus:ring-2 focus:ring-gem-red"
                    disabled={isLoading}
                />
                <button type="submit" disabled={isLoading || !query.trim()} className="p-3 bg-gem-red rounded-full text-white disabled:bg-gem-mist transition-colors" title="Send query">
                    <SendIcon />
                </button>
            </form>
        </div>
