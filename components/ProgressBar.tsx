...
const ProgressBar: React.FC<ProgressBarProps> = ({ progress, total, message, fileName }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full p-4 text-center">
        ...
        <div className="w-full max-w-md bg-gem-mist rounded-full h-4 overflow-hidden">
            <div
                className="bg-gem-red h-4 rounded-full transition-all duration-300 ease-in-out animate-progress-stripes"
                style={{ 
                    width: `${percentage}%`,
